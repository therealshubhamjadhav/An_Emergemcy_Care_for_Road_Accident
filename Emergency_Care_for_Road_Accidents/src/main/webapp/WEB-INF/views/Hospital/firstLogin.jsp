...
<head>
	...
	<link rel="stylesheet" href="<spring:url value='/css/usercss.css'/>" type="text/css" />
		...
		<div class="row">
			<div class="col-lg-3 col-md-2"></div>
				<div class="col-lg-6 col-md-8 login-box">
					...
					<h5	style="color: red; background-color: white; margin-right: 50px; margin-left: 50px;">${requestScope.error}</h5>
					<div class="col-lg-12 login-form">
						<div class="col-lg-12 login-form">
							...
							<div class="col-lg-6 login-btm login-button">
								<button onclick="validateUserForm()" type="submit" class="btn btn-outline-primary">Update Profile</button>
						</div>
					</div>
				</form>
			</div>
