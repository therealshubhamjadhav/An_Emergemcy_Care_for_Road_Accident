		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="<spring:url value='/Hospital/Dashboard'/>"> <i
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					<ul class="sidenav-second-level collapse" id="user">
						<li><a href="<spring:url value='/Hospital/hospitalprofile'/>">
								<i class="fa fa-fw fa-link"></i> Hospital Profile
						</a></li>
						<li><a href="<spring:url value='/Hospital/updatePassword'/>">
