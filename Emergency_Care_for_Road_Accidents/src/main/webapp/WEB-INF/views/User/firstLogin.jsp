	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 login-box">
				...
				<div class="col-lg-12 login-title">Update Your Profile</div>
				<h5
					style="color: red; background-color: white; margin-right: 50px; margin-left: 50px;">${requestScope.error}</h5>
					<h5
					style="color:green; background-color: white; margin-right: 50px; margin-left: 50px;">${requestScope.success}</h5>
