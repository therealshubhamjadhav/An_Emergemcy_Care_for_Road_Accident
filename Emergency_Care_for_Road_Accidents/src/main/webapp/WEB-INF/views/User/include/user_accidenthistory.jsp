...
<div class="content-wrapper">
	<div class="container-fluid">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active"> Accident History</li>
				...
				<table class="table table-bordered">
					...
					<% int sr_no=0; %>
						...
						<tr>
								...
								<td>${accident.nearestPoliceStation.name}</td>
								<td>${accident.status}</td>
							 <td> <a
									href='<spring:url value="/User/accident_delete?aid=${accident.id}"/>'><button
