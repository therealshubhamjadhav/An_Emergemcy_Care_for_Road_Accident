...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="<spring:url value='/User/Dashboard'/>"><img class="brand"
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					<li><a href="<spring:url value='/User/myprofile'/>"> <i
						...
						<li><a href="<spring:url value='/User/changepassword'/>"> <i
								class="fa fa-fw fa-link"></i> Change Passsword
						</a></li>
						<li><a href="<spring:url value='/User/updateimage'/>"> <i
								class="fa fa-fw fa-link"></i> Change Profile Picture
						</a></li>
						
						<li><a href="<spring:url value='/User/myvechical'/>"> <i
								class="fa fa-fw fa-link"></i> My Vechicle Information
						</a></li>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					<li><a href="<spring:url value='/User/hospitallist'/>"> <i
								class="fa fa-fw fa-link"></i> Find Hospital
						</a></li>
						
						<li><a href="<spring:url value='/User/addaccident'/>"> <i
								class="fa fa-fw fa-link"></i> Report Accident
						</a></li>
						
						<li><a href="<spring:url value='/User/accidentHistory'/>"> <i
								class="fa fa-fw fa-link"></i> Accident History
						</a></li>
