...
<div class="content-wrapper">
	<div class="container-fluid">
		<ol class="breadcrumb">
			...
			<a class="btn btn-primary rightside"
				href='<spring:url value="/PoliceStation/Dashboard"/>'>Back</a></li>
		</ol>
	...
	<div class="row form-group">
							<div class="col-md-12">
								<label class="col control-label text-center" for="station_name">
									Station Name </label>
								<div class="input-group">
									 <input id="station_name"
										name="station_name" value=${sessionScope.userDetails.name}
							...
							<div class="col-lg-4">
								...
								<div class="input-group">
									<input id="mobile" maxlength="15" name="alt_mobile"
										value=${sessionScope.userDetails.altMobileNo} class="form-control text-center"
										type="text" />
								</div>
							</div>
							<div class="col-lg-4">
			...
			<div class="row form-group">
				<div class="col-md-4">
					...
					<div class="input-group">
						<input id="city" name="city" value=${sessionScope.userDetails.policeStationAddress.city}
							class="form-control text-center" type="text" />
					</div>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="input-group">
						<i class="glyphicon glyphicon-list"></i> <input id="state"
							name="state" value=${sessionScope.userDetails.policeStationAddress.state} class="form-control text-center"
							type="text" />
					</div>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="input-group">
						<i class="glyphicon glyphicon-list"></i> <input id="district"
							name="district" value=${sessionScope.userDetails.policeStationAddress.district} class="form-control text-center"
							type="text" />
					</div>
				</div>
			</div>
			...
			<div class="row form-group">
				<div class="col-lg">
					<label class="col control-label text-center" for="add_ln">Complete
						...
						value=${sessionScope.userDetails.policeStationAddress.streetLine} class="form-control text-center"
						type="text" />
				</div>
			</div>
			<hr>
			...
			<div class="row form-group">
				<div class="col-lg-2">
					<label class="col control-label text-center" for="pin_code">Pin
						Code</label> <input id="pin_code" name="pin_code" value=${sessionScope.userDetails.policeStationAddress.pinCode} 
						class="form-control text-center" type="text" />
				</div>
				...
				<div class="col-lg-5">
					...
					<div class="input-group">
						<i class="glyphicon glyphicon-pencil"></i> <input id="country"
							name="country" value=${sessionScope.userDetails.policeStationAddress.country}  class="form-control text-center"
							type="text" />
					</div>
				</div>
			</div>
